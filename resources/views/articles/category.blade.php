...
@section('title', $categories[$category] . ' - Quản lý Nghĩa Địa')
...
<div class="mb-8">
    ...
    <div class="flex flex-wrap gap-2">
        <a href="{{ route('articles.index') }}" class="btn btn-ghost btn-sm {{ request()->route('category') === null ? 'btn-active' : '' }}">
            Tất cả
        </a>
...
@else
    <div class="card bg-base-100 shadow-lg border border-base-300">
        <div class="card-body text-center py-16">
            ...
            <p class="text-base-content/60 mb-4">Hiện tại chưa có bài viết nào trong danh mục {{ $categories[$category] }}</p>
