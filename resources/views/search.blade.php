            ...
            @if ($graves->count() > 0)
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                    @foreach ($graves as $grave)
                        <div
                            class="group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 bg-gradient-to-br from-white via-slate-50/50 to-green-50/30 border border-green-200/50">
                            <!-- Background Effects -->
                            <div
                            ...
                            <div class="relative card-body">
                                ...
                                <div class="flex items-start justify-between mb-3">
                                    ...
                                    <div
                                        class="badge {{ $grave->status === 'đã_sử_dụng' ? 'badge-success' : 'badge-ghost' }}">
                                        {{ $grave->status_label }}
                                    </div>
                                </div>
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                @if ($grave->deceased_birth_date && $grave->deceased_death_date)
                                                    <p class="text-xs text-base-content/70 mb-1">
                                                        <span class="font-medium">Sinh:</span>
                                                        {{ $grave->deceased_birth_date->format('d/m/Y') }}
                                                    </p>
                                                    <p class="text-xs text-base-content/70">
                                                        <span class="font-medium">Mất:</span>
                                ...
                                <div class="flex justify-end">
                                    <a href="{{ route('grave.show', $grave->id) }}"
                                        class="relative inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-500 to-red-500 hover:from-purple-700 hover:to-red-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 text-sm">
                                        Xem chi tiết
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="2" stroke="currentColor" class="h-4 w-4">
                                            <path stroke-linecap="round" stroke-linejoin="round"
