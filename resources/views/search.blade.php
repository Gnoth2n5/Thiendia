...
@section('content')
    ...
    <div class="mb-8">
        <div class="text-center mb-8">
            ...
            <h1 class="text-4xl font-bold mb-4" style="color: #8b0000;">
                Tìm kiếm lăng mộ
            </h1>
                    ...
                    <div class="hidden lg:block overflow-x-auto">
                        <table class="w-full">
                            ...
                            <thead style="background-color: #8b0000;" class="border-b">
                                <tr>
                                    <th class="px-4 py-4 text-left text-sm font-bold border-r"
                                        style="color: #f5f3e7; border-color: rgba(245,243,231,0.3);">STT</th>
                                    <th class="px-4 py-4 text-left text-sm font-bold border-r"
                                        style="color: #f5f3e7; border-color: rgba(245,243,231,0.3);">Họ tên liệt sĩ</th>
                                    <th class="px-4 py-4 text-left text-sm font-bold border-r"
                                        style="color: #f5f3e7; border-color: rgba(245,243,231,0.3);">Năm sinh</th>
                                    <th class="px-4 py-4 text-left text-sm font-bold border-r"
                                        style="color: #f5f3e7; border-color: rgba(245,243,231,0.3);">Năm hy sinh</th>
                                    <th class="px-4 py-4 text-left text-sm font-bold border-r"
                                        style="color: #f5f3e7; border-color: rgba(245,243,231,0.3);">Nghĩa trang</th>
                                    <th class="px-4 py-4 text-left text-sm font-bold border-r"
                                        style="color: #f5f3e7; border-color: rgba(245,243,231,0.3);">Huyện/TP</th>
                                    <th class="px-4 py-4 text-left text-sm font-bold border-r"
                                        style="color: #f5f3e7; border-color: rgba(245,243,231,0.3);">Xã/Phường</th>
                                    <th class="px-4 py-4 text-left text-sm font-bold border-r"
                                        style="color: #f5f3e7; border-color: rgba(245,243,231,0.3);">Loại mộ</th>
                                    <th class="px-4 py-4 text-center text-sm font-bold" style="color: #f5f3e7;">Thao tác
                                    </th>
                                </tr>
                            </thead>
        ...
        @else
            ...
            <div class="card shadow-lg border" style="background-color: #fafaf8; border-color: #d4d0c8;">
                <div class="card-body text-center py-16">
                    ...
                    <h3 class="text-xl font-bold mb-2" style="color: #2b2b2b;">Bắt đầu tìm kiếm</h3>
                    <p style="color: #2b2b2b; opacity: 0.6;">Nhập thông tin vào form phía trên để tra cứu lăng mộ</p>
                </div>
            </div>
        @endif
    </div>
